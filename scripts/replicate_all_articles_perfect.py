...
for filename, meta in articles_meta.items():
    ...
    # Extract the <article class="article-body"> ... up to </article> or <div class="article-tags-wrap"> or <section class="related
    body_match = re.search(r'<article class="article-body">(.*?)(</article>|<div class="article-tags-wrap">|<section class="related|<div class="related-grid")', en_html, flags=re.DOTALL)
    if not body_match:
...
print("Successfully generated all localized articles with new CTA across FR, ES, AR!")
