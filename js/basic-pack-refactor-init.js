  ...
  function renderBasic() {
    var data = {
      ...
      timeline: [
        ...
        { title: "Pool Access & Traditional Moroccan Tea", text: "Relax by the pool and enjoy a refreshing cup of traditional Moroccan mint tea, the perfect way to end your desert adventure.", icon: "check" }
      ],
      included: [
        "1 Hour Quad Biking",
        "20 Min Camel Ride",
