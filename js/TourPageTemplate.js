  ...
  function render(data, targetId = 'page-root') {
    ...
    const html = `
      ...
      <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
          <a class="navbar-brand" href="../index.html"><img src="../images/logo-trensparent.png" alt="Marragafay" style="width: 80px; height: auto;"></a>
      ...
      <!-- Hero Section -->
      <div class="hero-wrap js-fullheight" style="background-image: url('${bgImage}'); height: 60vh !important; min-height: 500px; background-size: cover; background-position: center;">
        <div class="overlay"></div>
        <div class="container">
          <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
            <div class="col-md-9 text-center ftco-animate fadeInUp ftco-animated">
              <h1 class="mb-4">${title}</h1>
              <p class="breadcrumbs"><span class="mr-2"><a href="../index.html">Home</a></span> <span>${subTitle}</span></p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="pack-sidebar" id="booking-section">
          <div class="booking-card">
            <div style="display: flex; justify-content: space-between; align-items: baseline; margin-bottom: 20px;">
              ...
              <div class="rating-badge" style="margin:0;">★ ${rating}</div>
            </div>

            <form id="bookingForm">
              <input type="hidden" name="package" value="${title}">
              <div class="form-group"><label style="font-size:0.85rem; font-weight:600; margin-bottom:5px; display:block;">Full Name</label><input type="text" class="booking-input" required></div>
              <div class="form-group"><label style="font-size:0.85rem; font-weight:600; margin-bottom:5px; display:block;">Email</label><input type="email" class="booking-input" required></div>
              <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                <div class="form-group"><label style="font-size:0.85rem; font-weight:600; margin-bottom:5px; display:block;">Date</label><input type="date" class="booking-input" required></div>
                <div class="form-group"><label style="font-size:0.85rem; font-weight:600; margin-bottom:5px; display:block;">Guests</label><select class="booking-input"><option>2 People</option><option>3 People</option><option>4 People</option></select></div>
              </div>
              <button type="submit" class="btn-reserve">Reserve Now</button>
            </form>
            
            <div class="trust-badges">
               <div class="trust-item">${icons.check} Secure</div>
               <div class="trust-item">${icons.star} Best Price</div>
            </div>
